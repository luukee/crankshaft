 ...
 */
add_action('wp_head', 'crankshaft_foundation_adminbar_styles');
function crankshaft_foundation_adminbar_styles() {
 ...
 */
add_filter( 'post_gallery', 'crankshaft_foundation_gallery_shortcode', 10, 2 );
function crankshaft_foundation_gallery_shortcode( $defaults = '', $attr ) {
	global $post;
	...
	$output = apply_filters( 'crankshaft_post_gallery', '', $attr );
	if ( $output != '' )
		return $output;
 ...
 */
add_filter('embed_oembed_html', 'crankshaft_foundation_embed_oembed_html', 99, 4);
function crankshaft_foundation_embed_oembed_html( $html, $url, $attr, $post_id ) {

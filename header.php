...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'crankshaft' ); ?></a>
	...
	<header id="masthead" class="site-header">
		...
		<nav id="site-navigation" class="main-navigation">
			<div class="title-bar" data-responsive-toggle="primary-menu" data-hide-for="medium">
				...
				<div class="title-bar-title"><?php esc_html_e( 'Menu', 'crankshaft' ) ?></div>
			</div>
